...
class FailScreen(Screen):
    def __init__(self, screen_size, clock, question, correct_answer, loader, next_button_action):
        super().__init__(screen_size, clock, loader)
        self.question = question
    ...
    def init_ui(self):
        self.question_text = pygame_gui.elements.UILabel(pygame.Rect((0, 0), (800, 100)), "Wrong! " + self.correct_answer, self.ui)
        self.next_button = pygame_gui.elements.UIButton(pygame.Rect((0, 100), (800, 100)), "Next", self.ui)
